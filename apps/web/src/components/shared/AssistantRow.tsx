 ...
 * surrounding label claims and nothing more. Drawn in one ink colour rather than
 * each brand's own palette: four competing brand colours (one of them a gradient)
 * would fight the page and each other, and a flat row reads as a compatibility
 * list instead of an endorsement.
 *
